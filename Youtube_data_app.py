...
def api_connect():
    api_key = "AIzaSyDTz9EGdpZ2mXR-jns4n-Tqfm4OczLJfGs"
...
uri = f"mongodb+srv://{encoded_username}:{encoded_password}@cluster0.ymdyfym.mongodb.net/?retryWrites=true&w=majority"
